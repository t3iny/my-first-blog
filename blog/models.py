...
class Post(models.Model):  # Объявление новой модели Post(наследуется от класса Model Django)
    ...
    title = models.CharField(verbose_name="Введите заголовок:", max_length=200)  # Символьное поле(НЕ БОЛЬШЕ 200).
    text = models.TextField(verbose_name="Введите текст поста:", max_length=700)  # Текстовое поле(НЕ БОЛЬШЕ 700).
